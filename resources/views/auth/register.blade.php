        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="name" name="name" placeholder="Tu cuenta" class="border p-3 w-full rounded-lg @error('name') border-red-500 @enderror"
                    value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="username" name="username" placeholder="Tu usuario" class="border p-3 w-full rounded-lg @error('username') border-red-500 @enderror"
                    value="{{ old('username') }}">
                    {{-- para k no se borre lo que colocaste en ell formulario si marca un error --}} 
                    @error('username')
                    <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                    @enderror
                </div>
